...
#  matching_files_B <- gsub("バ", "バ", matching_files_B)
  matching_files_B <- gsub("ISF08 マネジメントレビュー", "ISF08 マネジメントレビュー議事録", matching_files_B)
  ...
  matching_files_B <- gsub("ISF29 入退室管理台帳 第三者用", "ISF29 入退室管理台帳 第三者用（セキュリティーカード対応に移行）", matching_files_B)
...
parent <- c("~/Library/CloudStorage/Box-Box/Datacenter/Users/ohtsuka/2023/20230926/output/",
